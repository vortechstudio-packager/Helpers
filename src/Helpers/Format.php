...
namespace Vortechstudio\Helpers\Format;
...
function dateFrench($date, $hours = false): string
{
    if ($hours) {
...
function textForSlugify(string $string): string
{
...
function minToHours(string $minutes): string
{
